...
nlohmann::json CJsonController::ConvertToJson(const FLineNode& lineNodeInfo)
{
    return nlohmann::json();
}

bool CJsonController::ParseLineNodeInfo(const nlohmann::json& jsonData, std::map<std::string, FLineNode>& nodes)
{
    return false;
}
