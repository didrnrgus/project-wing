...
#define PLAYER_CHARACTER_RANK_TEXT L"Rank by Char"
#define PLAYER_MAP_RANK_TEXT L"Rank by Map"
#define PLAYER_LOBBY_NICKNAME_LENGTH_MAX_SCORE 20.0f
#define PLAYER_RANK_NICKNAME_LENGTH_MAX_SCORE 20.0f
